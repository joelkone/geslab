...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha512-HjjqT4cbQ2aL4+8zRJuoFv7K6+X/hB79pe8suQWd6UrFnD+UfA6ypcib6OejzJv0/MfZ9Jm75ay+ccKj06pV5w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-columns" viewBox="0 0 16 16">
            ...
            </svg>&nbsp;Liste analyses effectuées
          </a>
        </li>
        <li class="nav-item" >
          <a class="nav-link bg-warning" id="date-time"></a>
        </li>
        <li class="nav-item">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
            ...
            <strong>
                Agent : <?php @session_start(); echo $_SESSION["nomPrenom"];?>
            </strong></a>
        </li>
        <li class="nav-item">
          <a class="nav-link bg-danger" title="Fermer ma session" href="../pdo/deconnexion.php">
