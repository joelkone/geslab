...
<body>
	...
	<div class="container col-md-12" style=''>
		<h1 class="text-center">Statistiques des enregistrements par tranche d'âge</h1>
		<table class="table table-hover table-bordered ">
			...
			<tbody>
				...
				$sql = "SELECT DATE_FORMAT(datenrpat, '%Y-%m') AS mois, COUNT(CASE WHEN age BETWEEN 0 AND 4 THEN 1 END) AS `0_4_ans`, COUNT(CASE WHEN age BETWEEN 5 AND 9 THEN 1 END) AS `5_9_ans`, COUNT(CASE WHEN age BETWEEN 10 AND 14 THEN 1 END) AS `10_14_ans`, COUNT(CASE WHEN age BETWEEN 15 AND 19 THEN 1 END) AS `15_19_ans`,COUNT(CASE WHEN age BETWEEN 20 AND 24 THEN 1 END) AS `20_24_ans`,COUNT(CASE WHEN age BETWEEN 25 AND 29 THEN 1 END) AS `25_29_ans`,COUNT(CASE WHEN age BETWEEN 30 AND 34 THEN 1 END) AS `30_34_ans`,COUNT(CASE WHEN age BETWEEN 35 AND 39 THEN 1 END) AS `35_39_ans`,COUNT(CASE WHEN age BETWEEN 40 AND 44 THEN 1 END) AS `40_44_ans`,COUNT(CASE WHEN age BETWEEN 45 AND 49 THEN 1 END) AS `45_49_ans`,COUNT(CASE WHEN age BETWEEN 50 AND 54 THEN 1 END) AS `50_54_ans`,COUNT(CASE WHEN age BETWEEN 55 AND 59 THEN 1 END) AS `55_59_ans`,COUNT(CASE WHEN age BETWEEN 60 AND 1000 THEN 1 END) AS `60_1000_ans`,COUNT(*) AS `total` FROM patient WHERE YEAR(datenrpat) = 2023 GROUP BY MONTH(datenrpat) ASC";
