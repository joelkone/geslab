...
<body> 
  <nav class="navbar navbar-expand-md navbar-light bg-light fixed-top">
    <div class="container-fluid">
      ...
      <ul class="navbar-nav" style="display: flex; align-items:center; justify-content:space-between;" id="menu">
        <li class="nav-item menu-item" id="item1">
        ...
        <li class="nav-item menu-item" id="item1">
          <a class="nav-link" href="ajoutp.php">
        ...
        <li class="nav-item menu-item" id="item1">
          <a class="nav-link" href="affp.php">
        ...
        <li class="nav-item menu-item" id="item1">
          <a class="nav-link" href="ajoutAn.php">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-text-fill" viewBox="0 0 16 16">
              <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zM4.5 9a.5.5 0 0 1 0-1h7a.5.5 0 0 1 0 1h-7zM4 10.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 1 0-1h4a.5.5 0 0 1 0 1h-4z"/>
            </svg>&nbsp;Effectuer une Analyse</a>
        </li>

        <li class="nav-item menu-item" id="item1">
          <a class="nav-link" href="affAn.php">
            ...
            </svg>&nbsp;Patients ayant effectué des analyses</a>
        </li>
    ...
    <div class="dropdown mr-5">
          ...
          <strong><?php @session_start(); echo $_SESSION["nomPrenom"];?></strong>&nbsp;&nbsp;&nbsp;
       
        <a href="../pdo/deconnexion.php" title='Fermer ma session' class="text-danger">
