...
$sql_sexe = "SELECT analyses.destypana, COUNT(*) as nb_personnes FROM faireanalyses INNER JOIN analyses ON faireanalyses.idana = analyses.idana WHERE analyses.destypana = 1";
...
<div class="container mt-5 mt-2" >
	<h2>Statistique par sexe</h2>
